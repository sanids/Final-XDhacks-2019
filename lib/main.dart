...
void logError(String code, String message) =>
    ...
    speak() async {
  Tts.speak('Well come to Ayy Eye, double tap to initiate navigation');
}
      ...
      child: new InkWell(
        ...
        onDoubleTap: ()=> Navigator.push(context,
              new MaterialPageRoute(maintainState: false,
                  builder: (context) => new FlutterVisionApp())),
        child: new Column(
        mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
          new Image.asset('assets/images/Aeye.png'),
          new Text("Double Tap to Navigate", style: new TextStyle(color: Colors.white,fontSize: 30,)),
          ],
